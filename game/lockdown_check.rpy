...
label lockdown_check:
    ...
    if renpy.version_tuple > (7, 4, 10, 2178):
        ...
        "目前为止，上游的 Mod 模板仅在 {a=https://www.renpy.org/release/7.4.10}Ren'Py SDK 7.4.10 版本{/a} 经过测试。"
        ...
        menu:
            ...
            "我同意。":
                ...
                "您现在已经同意，可以继续 Mod 开发了。"
                return
            "我不同意。":
                "您选择了不同意，因此 DDLC 中文 Mod 模板将暂时停止在该版本 Ren'Py SDK 下工作，除非重新同意。"
                "如果您仍然希望开发 Mod，您应该暂时选择 {a=https://www.renpy.org/release/7.4.10}Ren'Py SDK 7.4.10 版本{/a}。"
